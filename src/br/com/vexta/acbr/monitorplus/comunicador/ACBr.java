...
public class ACBr {
     ...
     * @throws
     * br.com.vexta.acbr.monitorplus.comunicador.exceptions.ACBrException
     */
...
//        enviaComando.println(comando);
    ...
    public static void main(String[] args) throws ACBrException {
        ...
        System.out.println("ACBrMonitorPlus Comunicador: http://vexta.github.io/ACBrMonitorPlus-Comunicador/");
        System.out.println("Saiba mais: http://www.vexta.com.br");
